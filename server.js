...
const outcomes = [
  {
    ...
    text:
      "Your symptom description indicates that this is a self-healing condition. We recommend that you rest for few days. Contact us again if your condition gets worse or if symptoms remain for more than three days.",
    show_booking_button: false
  },
  {
    id: "see_a_doctor",
    text:
      "Your symptom description indicates that you are in need of medical care. Good news – KRY can help. Book an appointment with one of our doctors.",
